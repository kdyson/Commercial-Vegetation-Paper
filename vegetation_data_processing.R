...
## -- INDEPENDENT VARIABLES ------------------------------------------------------
    ...
    ## Load raw data sources
        ...
        population.covariates <- read.csv("popcovariateswtax.csv", stringsAsFactors = F)[-1]
...
## -- TREE DATA ------------------------------------------------------------------
    ...
    ## Load raw data sources
        ...
        tree.native <- read.csv("tree_native.csv", stringsAsFactors = FALSE)
...
## -- SHRUB DATA -----------------------------------------------------------------
    ...
    ## Create species/site matrices:
        ...
        # matrify.shrub.zones$prunus.laurocerasus +
        # matrify.shrub.zones$prunus.laurocerasus.zabeliana
        # matrify.shrub.zones$prunus.laurocerasus.zabeliana <- NULL
        ...
        # matrify.shrub.site$prunus.laurocerasus +
        # matrify.shrub.site$prunus.laurocerasus.zabeliana
        # matrify.shrub.site$prunus.laurocerasus.zabeliana <- NULL
...
## -- WRITE ---------------------------------------------------------------------
    ...
    if (write.all == TRUE) {
        ...
        write.csv(matrify.shrub.site, file = "matrify_shrub_bysite.csv")
        write.csv(matrify.shrub.zones, file = "matrify_shrub_byzone.csv")
    ...
    ## If you import these files, the following might be helpful...
    # matrify.tree.species <- read.csv("../../DataAnalysis/Vegetation/matrify.tree.species.csv",
    #                                  row.names = "X")
    # matrify.shrub.bysite <-  read.csv("../../DataAnalysis/Vegetation/matrify.shrub.bysite.csv",
    #                                   row.names = "X")
    # colnames(matrify.shrub.bysite)[4] <- "amelanchier.alnifolia"
    # colnames(matrify.shrub.bysite)[86] <- "viburnum.davidii"
